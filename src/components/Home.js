    ...
    <div className="home-page">
      <div className="fitness-img-container">
        ...
        <div className="text-container-browser-classes">
          ...
          <p>
           Our experienced bakers and cooks walk you through some of their delicious recipes. Dont worry we wont tell your friends that you got help. 

           Or make it a party and invite them to learn as well!
           You can choose from timed classes with experts or spend the day in our kitchen. 
          </p>
          <Link to="/browse">
      ...
      <div className="about-section">
        ...
        <div className="about-why-af">
          <div className="about">
            ...
            <ul>
              <li>
               <p> The Santilno Family has called this New York City Bourough home for many years. 
                   We are proud to bring our finest skills and tradiational methods from Italy to share here in NYC. 
                   We value family and community and want to invite you to share in making the world a sweeter place with us.
          ...
          <div className="why">
            ...
            <ul>
              ...
              <li>
                ...
                <p>
                  Done to work, we will be blasting some good tunes and teach you the best techniques. 
                </p>
              </li>
            </ul>
          </div>
