...
import glassBread from "../src/images/about-section-pic-1.png";
import pastries from "../src/images/why-section-pic.png";
      ...
      <div className="App">
        <div className="app-header">
          <div className="logo-container">
            ...
            <h3>
              <span className="word1">Maria's</span>
              <span className="word2">|</span>
              <span className="word3"> Bakery </span>
            </h3>
          </div>
          <nav>
            <Link to="/">Home </Link>
        ...
        <Switch>
          <Route exact path="/">
            <Home homepic={homepic} pic={glassBread} pic2={pastries} />
          </Route>
